...
func getStackoverflowDBConnection() (*sql.DB, error) {
	...
	connStr := "user=postgres dbname=StackoverflowDB password=1234 host=localhost sslmode=disable"
	return sql.Open("postgres", connStr)
}

func getGitHubDBConnection() (*sql.DB, error) {
	// Replace with your GitHub database connection details
	connStr := "user=postgres dbname=GitHubDB password=1234 host=localhost sslmode=disable"
	return sql.Open("postgres", connStr)
}
